    ...
    while True:
        ...
        if len(lmList) != 0:
            ...
            if len(lmList) > 8:
                ...
                if fingers[0] and fingers[1] and not fingers[3] and not fingers[2] and not fingers[4]:
            ...
            if all(fingers):
                if all_fingers_raised_start_time is None:
                    ...
                    exit_event.set()  # Set the event to stop the server
                    break
            else:
                all_fingers_raised_start_time = None
        ...
        # cv2.putText(img_for_annotations, f'FPS: {int(fps)}', (10, 450), cv2.FONT_HERSHEY_PLAIN, 2, (0, 255, 0), 2)
...
def generate_frames():
    ...
    while True:
        ...
        # Convert to byte array and yield as a streaming response
